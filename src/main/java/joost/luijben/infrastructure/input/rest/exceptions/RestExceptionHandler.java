package joost.luijben.infrastructure.input.rest.exceptions;
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<ErrorModel> handleEntityExistsException(ConstraintViolationException ex) {
